...
\subfloat{\includegraphics[width=0.3\textwidth]{pictures/undet_3.jpg}}\\
...
In figure \todo{do this} we present the difference in the approach picked by the agent
...
\begin{figure}[tbh]
    \begin{center}
    \subfloat[Initial parking lot state.]{\includegraphics[width=0.40\textwidth]{pictures/walk_4_drive_15_wait_1_data_artificial_states.pdf}}\hspace{2mm}
    \subfloat[$1_{st}$ iteration.]{\includegraphics[width=0.40\textwidth]{pictures/walk_4_drive_15_wait_1_data_artificial_path_1.pdf}}\\
    \subfloat[$3_{rd}$ iteration.]{\includegraphics[width=0.40\textwidth]{pictures/walk_4_drive_15_wait_1_data_artificial_path_3.pdf}}\hspace{2mm}
    \subfloat[$6_{th}$ iteration.]{\includegraphics[width=0.40\textwidth]{pictures/walk_4_drive_15_wait_1_data_artificial_path_6.pdf}}\\
    \subfloat[$18_{th}$ iteration.]{\includegraphics[width=0.40\textwidth]{pictures/walk_4_drive_15_wait_1_data_artificial_path_18.pdf}}\hspace{2mm}
    \subfloat[$58_{th}$ iteration.]{\includegraphics[width=0.40\textwidth]{pictures/walk_4_drive_15_wait_1_data_artificial_path_58.pdf}}
    \end{center}
    \caption{An optimal strategy for $v_{walk} = 4$ km/h, $v_{drive} = 15$ km/h and the failure cost of 1 seconds.}
    \label{fig:w_4_d_15_w_1_artificial}
\end{figure}
