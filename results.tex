...
Our final negative dataset contains 7972 images, each of which is $128 \times
128$ pixels big. The system shows the performance of \todo{add detection rate
for my approach} in detecting the cars the camera faces. Some of the detection
...
\todo{do a photo of the robot with a camera} As can be seen in the figure, the
...
chapter \nameref{cha:our_approach}, section \nameref{sec:perception} The
precision of car position modeling can be seen in the figure. \todo{what to
write more???} % section occupancy_modeling (end)
