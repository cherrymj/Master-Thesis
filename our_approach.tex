...
\begin{figure}[ht]%
\centering
\subfloat{\includegraphics[width=0.8\textwidth]{pictures/laser_fusion.pdf}} \\
\subfloat{\includegraphics[width=0.8\textwidth]{pictures/occupancy_cars.pdf}} \\
\subfloat{\includegraphics[width=0.8\textwidth]{pictures/parking_lots_detections.pdf}}
...
To solve the MDP we make use if the policy iteration algorithm which we
